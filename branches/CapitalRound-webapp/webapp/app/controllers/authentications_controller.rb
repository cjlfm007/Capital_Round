...
# ---------------- End demo -----------------
  ...
  def create
    ...
    if user_errors == nil and authentication_errors == nil
      ...
      respond_to do |format|
        if authentication_errors != nil
          @authentication.errors.add :password, user_errors
          
        end
        if user_errors != nil
          @authentication.errors.add :username, authentication_errors
        end
        format.html { render action: "new"}
